    ...
    <section class="form">
        <form action="" method="POST" class="tableAdmin ">
            <div class="tableHeader row">
             ...
             <div class="cadastro-ok"> Deletado com sucesso! </div>
            <div class="tableBody">
                <div class="row bg-1">
                    ...
                    <ul class="list lv01">
                        <li class="row">
                            ...
                            <div class="cell cell-100 text-center">
                                ...
                                <a onclick="confirm('Deseja excluir este registro?') ? window.location = '../../classes/deleta-artesanato-c.php?id=<?php echo $artesanato->getIdArtesanato(); ?>' : stop = false;" > <i class="far fas fa-trash icone-acoes-admin"/></i></a>
                            </div>
