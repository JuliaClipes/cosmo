<?php include_once '../nav-admin.php'; ?> <!-- NÃO ESTÁ INCLUINDO -->
<div class="direita">
    <section class="form">
        <form action="classes/cadastro-admin-c.php" method="POST" enctype="multipart/form-data" class="tableAdmin">
            ...
            <div class="tableBody v02">
                ...
                <div class="cadastro-ok"> Cadastrado com sucesso! Faça login em "Entrar" no menu superior da página de Usuários. </div>
