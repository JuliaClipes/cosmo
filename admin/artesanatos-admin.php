            ...
            <form action="" method="GET" class="tableAdmin ">
                <div class="tableHeader row">
                    ...
                    <div class="btnArea">
                        ...
                        <button class="btnAdicionar bg-1 text-fff"><a href="artesanatos-edit.php" class="a-button">Novo Artesanato</a></button> 
                    </div>
                </div>
                <div class="tableBody">
                    <div class="row bg-1">
                    ...
                    <ul class="list lv01">
                        <li class="row">
                            ...
                            <div class="cell cell-100 text-center">
                                <a href=""><img src="assets/img/artesanato-ilustra.png" alt="" class="cell-100p"></a>
                            </div>
                            <div class="cell cell-100">Artesanato 1</div>
                            <div class="cell cell-100 text-center">
                            </div>
