    ...
    <body>
        ...
        <div class="esquerda">
            <nav class="vertical-menu">
                <ul> <?php foreach ($lista_admin as $admin): ?>
                        <a href="index.php" class="a-menu"> <li class="active">  <i class="far fas fa-user icone-index-admin"/></i>Olá, <?php echo $admin->getNomeAdmin(); ?> </li>  </a>
                    <?php endforeach; ?> 
                    ...
                    <li> <a class= "item-menu" href="perfil-admin.php"> <i class="far fas fa-user icone-index-admin-ma"></i>Perfil</a></li>
                    <li> <a class= "item-menu" href="../index.php"> <i class="far fas fa-power-off icone-index-admin-ma"></i>Sair</a></li>
                </ul>
            </nav>
        </div>
